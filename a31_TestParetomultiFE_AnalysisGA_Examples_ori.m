...
% % strnamex = '$$ ' + strnamex + ' $$';
% 
% strnamey = ["obj FE";"obj EI (W/ton CO)";"obj j_{COER} (mA/cm^2)"];
% % strnamey = '$$ ' + strnamey + ' $$';
% figPF = figure;
...
%         legend([oripic,PSpic],["data set","PF by GA"],'location','southwest',...
%             'FontSize',15,'Interpreter','tex');
%         
% %         print(['0Fig31 Pareto set vs objective 2D GA ',num2str(i),num2str(j)],'-djpeg','-r1200')
% 
%     end
% end
% 
