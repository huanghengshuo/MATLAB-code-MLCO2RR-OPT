...
h1.XDisplayLabels = {'$$\varepsilon_\mathrm{GDL} $$','$$\varepsilon_\mathrm{CL} $$','$$ \varphi $$','$$\mathrm{FE} $$'};
h1.YDisplayLabels = h1.XDisplayLabels;

title('Pearson partial correlation');
print('0Fig01a partialcorrPearson','-djpeg','-r1200') 

f2 = figure;
h2 = heatmap(f2,xvalues,yvalues,rhoS,'GridVisible','off','FontName',...
    'Times New Roman','FontSize',12,'CellLabelFormat','%0.4f','ColorLimits',[-0.3 1],'Interpreter','latex');
h2.XDisplayLabels = {'$$\varepsilon_\mathrm{GDL} $$','$$\varepsilon_\mathrm{CL} $$','$$ \varphi $$','$$\mathrm{FE} $$'};
h2.YDisplayLabels = h2.XDisplayLabels;

title('Spearman partial correlation');
print('0Fig01a partialcorrSpearman','-djpeg','-r1200') 
...
h3.XDisplayLabels = {'$$\varepsilon_\mathrm{GDL} $$','$$\varepsilon_\mathrm{CL} $$','$$ \varphi $$','$$\mathrm{FE} $$'};
h3.YDisplayLabels = h3.XDisplayLabels;

title('Pearson correlation');
print('0Fig01a corrPearson','-djpeg','-r1200') 


f4 = figure;
h4 = heatmap(f4,xvalues,yvalues,rhoS,'GridVisible','off','FontName',...
    'Times New Roman','FontSize',12,'CellLabelFormat','%0.4f','ColorLimits',[-0.3 1],'Interpreter','latex');
h4.XDisplayLabels = {'$$\varepsilon_\mathrm{GDL} $$','$$\varepsilon_\mathrm{CL} $$','$$ \varphi $$','$$\mathrm{FE} $$'};
h4.YDisplayLabels = h4.XDisplayLabels;

title('Spearman partial correlation');
print('0Fig01a corrSpearman','-djpeg','-r1200') 
