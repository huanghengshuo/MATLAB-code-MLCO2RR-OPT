...
tic
load('RGPCVardsquaredexponential.mat')
load('RGPardsquaredexponential.mat')
%% Input original data
...
GaussModel0 = GaussModel;
TreeModel = GaussModel0;

TreeModelCV = GaussModelCV;
...
print('0Fig31 plotPartialDependence Gauss FE','-djpeg','-r1200') 
...
% print('0Fig31 plotPartialDependence Gauss j','-djpeg','-r1200') 
...
% [xx,fval,exitflag,output,residuals] = paretosearch(@HHtarget,3,[-1,1,0],0,[],[],lb,ub,@HHcirclecons,options);
...
% save xx and fval
save Pareto3varsGAGauss.mat xx fval XX Fval
...
print('0Fig31 Pareto set vs objective GA Gauss','-djpeg','-r1200') 
