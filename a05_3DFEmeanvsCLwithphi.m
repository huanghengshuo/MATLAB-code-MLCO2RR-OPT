...
ylabel("FE_{CO}","FontSize",18,"FontName","Arial");
...
scatter(FEexp,FEsim,'SizeData',100,...
    ...
    'MarkerEdgeAlpha',0.8,'MarkerFaceAlpha',0.5)
plot([0.85 1],[0.85 1],'k-','LineWidth',2.5)
xlim([0.85 1])
ylim([0.85 1])
...
splot = contourf(xq,yq,vq,[-0.03:0.005:-0.01,-0.01:0.003:0,0:0.003:0.016,0.019]);
...
annotation(fig,'textbox',...
    ...
    'FontName','Arial',...
    'FitBoxToText','off');
print('0Fig05 dFE vs CL with phi','-djpeg','-r1200') 
